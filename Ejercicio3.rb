Se tiene la clase Vehicle que recibe como argumento un modelo y un año. El método engine_start enciende el
vehículo.
...
El constructor de Car, además de heredar las propiedades de Vehicle, debe incluir un contador de
instancias de Car.
...
# marcas = ['Toyota', 'Chevrolet', 'Audi', 'Ferrari', 'Seat', 'Citroen', 'Cherokee']

# 10.times do |i|
# 	car = Car.new(marcas.sample, rand(2000..2010))
# 	puts "Se ha creado un #{car.model} del año #{car.year}"
# end

# puts Car.mostrar_contador
# puts "Se han instanciado #{Car.mostrar_contador} autos"